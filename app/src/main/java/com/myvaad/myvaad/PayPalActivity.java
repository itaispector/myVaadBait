...
public class PayPalActivity extends Activity {
    ...
    private String payment, amount, objectId, uObjectId, email, selectedYear, buildingCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectedYear = i.getStringExtra("selectedYear");
        buildingCode = i.getStringExtra("buildingCode");
                            ...
                            ParseObject.saveAllInBackground(payments, new SaveCallback() {
                                ...
                                public void done(ParseException e) {
                                    if (e == null) {
                                        ...
                                        query.whereEqualTo("period", "01");
                                        query.getFirstInBackground(new GetCallback<ParseObject>() {
                                            @Override
                                            public void done(ParseObject parseObject, ParseException e) {
                                                if (e == null) {
                                                    parseObject.addUnique("paidBy", uObjectId);
                                                    parseObject.addUnique("paidAll", uObjectId);
                                        ...
                                        public void done(List<ParseObject> list, ParseException e) {
                                            if (e == null) {
                                                ...
                                                for (int i = 0; i < list.size(); i++) {
                                                    if (list.get(i).getList("paidBy") != null) {
                                                        if (((list.get(i).getList("paidBy")).contains(uObjectId))) {
                                                            counter++;
                                                        }
                                                    }
                                                }
                                                if (counter == 12) {
                                                    ...
                                                    user.addUnique("paidBy", uObjectId);
                                                    user.addUnique("paidAll", uObjectId);
